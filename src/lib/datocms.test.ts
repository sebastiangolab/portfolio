...
describe('datocms', () => {
  ...
  describe('performRequest', () => {
    ...
    it('should pass query and variables correctly', async () => {
      const mockQuery = 'query ($first: Int) { allRealizations(first: $first) { title } }';
    ...
    it('should throw error when response is not ok', async () => {
      ...
      await expect(performRequest({ query, variables: {}, revalidate: undefined })).rejects.toThrow(
    ...
    it('should throw error with correct status code', async () => {
      ...
      await expect(performRequest({ query, variables: {}, revalidate: undefined })).rejects.toThrow('401 Unauthorized');
    });
    ...
    it('should handle network errors', async () => {
      ...
      await expect(performRequest({ query, variables: {}, revalidate: undefined })).rejects.toThrow('Network error');
    });
    ...
    it('should return only data property from response', async () => {
      ...
      const result = await performRequest({ query: 'query { test }', variables: {}, revalidate: undefined });
    ...
    it('should handle complex nested data structures', async () => {
      ...
      const result = await performRequest({ query: 'query { complex }', variables: {}, revalidate: undefined });
